...
import configs.ViTPose_huge_doodle_256x192 as cfg

from vit_models.model import ViTPose

# from datasets.COCO import COCODataset
from datasets.Doodle import DoodleDataset
...
def main(config_path, model_name):
    ...
    if not hasattr(cfg, "work_dir"):
        cfg.__setattr__("work_dir", f"./runs/train")
    ...
    datasets_train = DoodleDataset(
        ...
        flip_prob=0.5, # 0.5
        rotate_prob=0.5, # 0.5
        rotation_factor=45, # 45.0
        half_body_prob=0.3, #0.3
